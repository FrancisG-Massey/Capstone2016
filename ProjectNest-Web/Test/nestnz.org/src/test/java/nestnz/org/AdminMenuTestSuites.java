...
public class AdminMenuTestSuites {
  ...
  private void testAdminMenuTestSuites() throws Exception {
    ...
    assertTrue(isElementPresent(By.linkText("Traplines")));
    assertEquals("Users", driver.findElement(By.linkText("Users")).getText());
  }
