...
public class LoginSuccessTestSuites {
...
// Test if login is successful with a user's valid email address and password
  private void testLoginErrorsTestSuites() throws Exception {
